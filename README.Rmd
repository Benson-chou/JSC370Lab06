...
institution <- str_extract_all(
  publications_txt,
  "University\\s+of\\s+[[:alpha:]-_]+ | [[:alpha:]-_]+\\s+ Institute\\s+of\\s+[[:alpha:]-_]+ "
  ) 
...
schools_and_deps <- stringr::str_extract_all(
  publications_txt,
  "School\\s+of\\s+[[:alpha:]-_]+ | Department\\s+of\\s+[[:alpha:]-_]+"
  )
...
53 of these don't have an abstract.
